...
function createPersistedState(options = {}) {
  return function(context) {
    createPersistence(context, (p) => {
      ...
      return {
        key: (options.key ? options.key : (x) => x)((_a = p.key) != null ? _a : context.store.$id),
        debug: (_c = (_b = p.debug) != null ? _b : options.debug) != null ? _c : false,
        serializer: (_e = (_d = p.serializer) != null ? _d : options.serializer) != null ? _e : {
          serialize: (data) => JSON.stringify(data),
          deserialize: (data) => destr(data)
        },
        storage: (_g = (_f = p.storage) != null ? _f : options.storage) != null ? _g : window.localStorage,
